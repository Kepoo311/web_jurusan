        ...
        <section class="flex flex-col" >
            ...
            <form class="m-20 h-fit" action="/register" method="post">
                ...
                <div class="mb-6 gap-4">
                    ...
                    <input value="{{old("username")}}" class="@error('username') is-invalid @enderror bg-[rgb(210,180,180)] w-full border-1 border-red-500 rounded-md" type="text" name="username" id="username" placeholder="Your Username....">
                    @error('username')
