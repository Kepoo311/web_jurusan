                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button"
                                ...
                                <img class="w-8 h-8 rounded-full" src="{{ asset('img/pfp.png') }}" alt="user photo">
                            </button>
                        </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        aria-controls="artikel" data-collapse-toggle="artikel">
                    ...
                    <ul id="artikel" class="hidden py-2 space-y-2">
                        <li>
                        ...
                        <li>
                            <a href="/dashboard/manage/artikel"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="prestasi" data-collapse-toggle="prestasi">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Prestasi</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4" />
                    ...
                    <ul id="prestasi" class="hidden py-2 space-y-2">
                        <li>
                        ...
                        <li>
                            <a href="/dashboard/manage/prestasi"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="banner" data-collapse-toggle="banner">
                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Banner</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4" />
                    ...
                    <ul id="banner" class="hidden py-2 space-y-2">
                        <li>
                        ...
                        <li>
                            <a href="/dashboard/manage/banner"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Manage</a>
                        </li>
                    </ul>
                </li>
